...
def parse_arg():
    ...
    return model_path, platform, do_quant, output_path, quantized_algorithm, batch_size

if __name__ == '__main__':
    model_path, platform, do_quant, output_path, quantized_algorithm, batch_size = parse_arg()
